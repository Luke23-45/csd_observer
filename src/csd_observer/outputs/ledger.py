...
class RunLedger:
    ...
    def __init__(self, ledger_dir: str | Path = "outputs/_ledger") -> None:
    ...
    def append(self, row: LedgerRow) -> None:
        ...
        with self.lock:
            self._atomic_append(self.jsonl_path, payload)
            self._rebuild_index()
