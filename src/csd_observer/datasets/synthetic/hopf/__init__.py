"""Synthetic supercritical-Hopf system wrapper (registry contract §5.6)."""
...
def build_bundle_hopf(**overrides: Any) -> dict[str, Any]:
    """Synthetic supercritical-Hopf bundle; see ``synthetic.common.build_bundle``."""
...
def build_signal_null(overrides: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    signal = build_bundle_hopf(seed=seed, null=False, **rest)
    null = build_bundle_hopf(seed=null_seed, null=True, **rest)
    return {"signal": signal, "null": null, "meta": signal["meta"]}


__all__ = ["build_bundle_hopf", "build_signal_null", "_SYSTEM"]
